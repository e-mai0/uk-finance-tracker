...
// Copied from api/chat/route.ts and adapted for CV sessions (kind="cv-builder").
...
export async function POST(req: Request) {
  ...
  // Persist the user message up front so it survives aborts
  try {
