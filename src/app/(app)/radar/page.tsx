 ...
 * how it's read, when it last ran, and what needs attention (watched
 * custom-ATS pages that changed, sources we currently can't reach, and any
 * disabled feeds).
 */
    ...
    <div className="animate-rise mx-auto max-w-6xl space-y-5 px-4 py-6">
      <div>
        ...
        <p className="mt-0.5 max-w-2xl text-sm text-muted">
          ...
          scraped or auto-published from them. Sources we can&rsquo;t currently
          reach are flagged, not hidden.
        </p>
      </div>
